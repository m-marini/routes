...
public class MapElementPane extends JPanel {
	...
	private SiteNodePane siteNodePane;

	private MapNodePane mapNodePane;
	...
	private void createContent() {
		...
		Box empty = Box.createVerticalBox();
		empty.setBorder(BorderFactory.createTitledBorder(Messages
				.getString("MapElementPane.emptyPane.title"))); //$NON-NLS-1$
	 ...
	 */
	public void setSelectedElement(SiteNode node) {
		if (node != null) {

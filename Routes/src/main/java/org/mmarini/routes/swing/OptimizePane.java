...
public class OptimizePane extends Box {
	...
	public OptimizePane() {
		...
		optimizeSpeed = new JCheckBox(
				Messages.getString("OptimizePane.optimizeSpeed.label")); //$NON-NLS-1$
		optimizeNodes = new JCheckBox(
				Messages.getString("OptimizePane.optimizeNodes.label")); //$NON-NLS-1$

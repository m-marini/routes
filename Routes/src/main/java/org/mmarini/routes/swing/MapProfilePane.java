...
public class MapProfilePane extends Box {
	...
	public MapProfilePane() {
		...
		difficultyModel = new DefaultComboBoxModel(
				new Object[] {
						Messages.getString("MapProfilePane.difficulty.easy.text"), //$NON-NLS-1$
						Messages.getString("MapProfilePane.difficulty.medium.text"), Messages.getString("MapProfilePane.difficulty.hard.text") }); //$NON-NLS-1$ //$NON-NLS-2$

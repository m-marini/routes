...
public class TrafficInfo {
	...
	/**
	 * @param totalDelayTime
	 *            the totalDelayTime to set
	 */
	...
	/**
	 * @param veicleCount
	 *            the veicleCount to set
	 */
	public void setVeicleCount(int veicleCount) {

...
public abstract class AbstractSimulationFunctions implements Constants {
	 ...
	 * @return
	 */
	public abstract double computeSpeedByVeicles(double distance,
			int veicleCount);
	 ...
	 * @return
	 */
	public abstract double computeTrafficLevel(double distance,
			int veicleCount, double speedLimit);
	 ...
	 * @return
	 */
	public abstract double computeTransitTime(double distance,
			double speedLimit, int veicleCount);

...
public class MainFrame extends JFrame {
	...
	private MapViewPane routeMap;
	private AbstractAction newRandomAction;
	private AbstractAction newAction;
	private AbstractAction infosAction;
	private AbstractAction veicleInfosAction;
	private AbstractAction exitAction;
	private AbstractAction openAction;
	private AbstractAction saveAction;
	private AbstractAction saveAsAction;
	private AbstractAction optimizeAction;
	private AbstractAction frequenceAction;
	private AbstractAction randomizeAction;
	private AbstractAction routesAction;
	private AbstractAction stopAction;
	private AbstractAction speedx1Action;
	private AbstractAction speedx2Action;
	private AbstractAction speedx5Action;
	private AbstractAction speedx10Action;
	...
	public MainFrame() throws HeadlessException {
		...
		URL url = getClass().getResource(IMAGES_ROUTES);
		if (url != null) {
	...
	private void createMenuBar() {
		...
		menu.setMnemonic(Integer.valueOf(Messages.getString(
				"MainFrame.fileMenu.mnemonic").charAt(0))); //$NON-NLS-1$
		...
		menu.setMnemonic(Integer.valueOf(Messages.getString(
				"MainFrame.viewMenu.mnemonic").charAt(0))); //$NON-NLS-1$
		...
		menu.setMnemonic(Integer.valueOf(Messages.getString(
				"MainFrame.optionMenu.mnemonic").charAt(0))); //$NON-NLS-1$
		...
		JCheckBoxMenuItem item2 = new JCheckBoxMenuItem(stopAction);
		menu.add(item2);

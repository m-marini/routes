 ...
 * 
 */
public class RouteHandler extends DefaultHandler implements XmlConstants, Constants {

	private final StringBuffer buffer;

	private final Map<String, MapNode> nodeTable;
	 ...
	 */
	@Override
	public void characters(final char[] bfr, final int offset, final int size) throws SAXException {
	...
	public void endElement(final String uri, final String localName, final String qName) throws SAXException {
		if (SITE_ELEM.equals(localName)) {
			...
			final String id = getBuffer().toString();
			final MapNode node = getNodeTable().get(id);
			if (node == null) {
				throw new SAXParseException("Missing node " + id, getDocumentLocator());
			}
			if (!(node instanceof SiteNode)) {
				throw new SAXParseException("Node " + id + " is not a SiteNode", getDocumentLocator());
			}
	 ...
	 */
	public void setBuilder(final MapBuilder builder) {
	 ...
	 */
	private void setDefaultElement(final boolean defaultElement) {
	...
	/**
	 * @param documentLocator the documentLocator to set
	 */
	@Override
	 ...
	 */
	private void setEdge(final MapEdge edge) {
		this.edge = edge;
	}

	/**
	 * @param mapNode the mapNode to set
	 */
	private void setMapNode(final MapNode mapNode) {
	 ...
	 */
	private void setSiteNode(final SiteNode siteNode) {
	...
	public void startElement(final String uri, final String localName, final String qName, final Attributes attr)
		...
		if (SITE_ELEM.equals(localName)) {
			...
			setSiteNode(site);
			final String id = attr.getValue(ID_ATTR);
